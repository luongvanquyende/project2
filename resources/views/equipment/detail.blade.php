...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <button type="button" class="btn btn-sm btn-blue waves-effect waves-light float-right" data-toggle="modal" data-target="#custom-modal">
                ...
                <table class="table table-hover m-0 table-centered dt-responsive nowrap w-100" id="tickets-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="javascript: void(0);">
                                    <img src="{{asset('assets/images/users/user-10.jpg')}}" alt="contact-img"
                                        title="contact-img" class="rounded-circle avatar-xs" />
                                </a>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript: void(0);">
                                    <img src="{{asset('assets/images/users/user-9.jpg')}}" alt="contact-img"
                                        title="contact-img" class="rounded-circle avatar-xs" />
                                </a>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript: void(0);" class="text-body">
                                    <img src="{{asset('assets/images/users/user-8.jpg')}}" alt="contact-img"
                                        title="contact-img" class="rounded-circle avatar-xs" />
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript: void(0);">
                                    <img src="{{asset('assets/images/users/user-1.jpg')}}" alt="contact-img"
                                        title="contact-img" class="rounded-circle avatar-xs" />
                                </a>
                            </td>
